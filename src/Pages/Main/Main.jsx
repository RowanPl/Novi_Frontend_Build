        ...
        <>
            <section className="text-section-container">
                ...
                <p>Je zet eenmalig een eigen omgeving op binnen de backendserver door je aan te melden via dit
                    ...
                    applicatie. Vervolgens bevestig je het aanmaken van de omgeving via de bevestigingsmail die wordt
                ...
                <p>Alle endpoints zijn beschikbaar op de volgende
                    ...
                    druk hiervoor wel eerst even op de <em>'Authorize'</em>-knop aan het begin van iedere sessie.</p>
                <Docs/>
            </section>
        </>
    )
