        ...
        <>
            <section className="hero-section-container">
                <section className="text-section-container">
                    ...
                    <p> <strong>Deze backend is gebouwd door en voor NOVI en mag alleen worden gebruikt voor
                        ...
                        via <a href="https://novi.datavortex.nl/Create">dit</a> formulier.</strong></p>
                    ...
                    <p>Je zet eenmalig een eigen omgeving op binnen de backendserver door je aan te melden via dit
                        ...
                        applicatie. Vervolgens krijg je in je email een API-KEY waarmee je gebruikers kan aanmaken. Meer
                        informatie staat in de email. </p>
                    ...
                    <p>Alle endpoints zijn beschikbaar op de volgende
                        ...
                        Je hebt voor alle request (behalve voor het aanmaken van gebruikers en het ophalen van een JWT
                        token) een JWT token nodig.</p>


                    <button className="instructie-button"
                            onClick={() => setShowVideo(!showVideo)}> {showVideo === false ? "Uitleg JWT toevoegen" : "Sluit de video"}</button>
